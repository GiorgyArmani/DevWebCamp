...
<section class="boletos">
    <h2 class="boletos__heading">Tickets & Precios</h2>
    <p class="boletos__descripcion">Escoge tu Ticket para DevWebCamp</p>
    ...
    <div class="boleto__enlace-contenedor">
        <a href="/packs" class="boleto__enlace">Elige tu Pack!</a>
    </div>
</section>