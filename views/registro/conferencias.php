...
<div class="eventos-registro">
    <main class="eventos-registro__listado">
        ...
        <p class="eventos-registro__fecha">Sabado 5 de Octubre</p>
        ...
        <p class="eventos-registro__fecha">Domingo 6 de Octubre</p>
    ...
    <aside class="registro">
            ...
            <div class="registro__regalo">
                ...
                <form id="registro" class="registro__formulario">
