...
class Paginacion {
    ...
    {          // esto es castear ↓ un valor convierte el tipo de dato en base a lo que le pedimos en este casoa  entero
   ...
   public function paginas_totales(){
   ...
   public function pagina_siguiente(){
    ...
    return ($siguiente <= $this->paginas_totales())? $siguiente : false;
   }
   ...
   public function paginacion(){
    ...
    if($this->total_registros > 1){
        ...
        $html.= $this->numero_pagina();  // muestra los numeros de la paginacion
   ...
   public function numero_pagina(){
    ...
    for($i = 1; $i <= $this->paginas_totales(); $i++){
        if($i === $this->pagina_actual){
            $html .= "<span class=\"paginacion___enlace paginacion__enlace--actual \">{$i}</span>";
        }else{
